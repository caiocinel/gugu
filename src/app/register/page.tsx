...
const formSchema = z.object({
  username: z.string().min(1, {
    message: "g gugug gu gugu gug 1 gugugugugu.", //O usuário precisa ter pelo menos 1 caractere
  }).max(4, {
    message: "g gugugug gu gugu gug 4 gugugugugu.", //O usuário só pode ter 4 caracteres
  }),
  password: z.string().min(1, {
    message: "g gugug gu gugu gug 1 gugugugugu.", //a senha precisa ter pelo menos 1 caractere
  }).max(4, {
    message: "g gugug gu gugu gug 4 gugugugugu.", //a senha só pode ter 4 caracteres
  }),    
})
            ...
            <Form {...form}>
              ...
              />
                ...
                <div className="w-full flex">
                  <Link href={'/login'}><p className="text-xs my-auto">Gu gug gug gugug?</p></Link>
